 ...
 * @author ADMIN
 */
@WebServlet(urlPatterns = {"/FindMinMax"})
public class FindMinMax extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FindMinMax</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FindMinMax at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try (PrintWriter out = resp.getWriter()) {
            if (req.getParameter("xoa") != null){
                resp.sendRedirect("MinMax.jsp");
                return;
            }
    ...
    private String checkInput(String a, String b, String c) {
        ...
        if (a.isEmpty()) {
            if (b.isEmpty()) {
                if (c.isEmpty()) {
                    return "All inputs are empty!";
                } else {
                    return "Inputs a and b are empty!";
                }
            } else if (c.isEmpty()) {
                return "Inputs a and c are empty!";
            } else {
